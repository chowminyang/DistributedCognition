 ...
 *   CODEX_MODEL_FAST / CODEX_MODEL_DEEP plus effort variants — optional model router overrides
...
registerProviderContainerConfig('codex', (ctx) => {
  ...
  const envKeys = [
    ...
    'CODEX_MODEL_EFFORT_FAST',
    'CODEX_MODEL_EFFORT_DEEP',
    'OPENAI_BASE_URL',
  ] as const;

  const dotenv = readEnvFile([...envKeys]);
